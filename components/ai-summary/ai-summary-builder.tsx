...
const COPY = {
  en: {
    title: "AI Summary",
    subtitle: "Create a project summary from selected inspection reports and project letters.",
    ...
    documents: "Project letters",
    noInspections: "No inspection responses are available for this project.",
    noDocuments: "No project letters are available.",
    ...
    selectSource: "Select at least one inspection report or project letter.",
    unavailable: "No source records are available yet.",
  },
  ar: {
    title: "الملخص بالذكاء الاصطناعي",
    subtitle: "إنشاء ملخص للمشروع من تقارير التفتيش والمراسلات المحددة.",
    ...
    documents: "مراسلات المشروع",
    noInspections: "لا توجد استجابات تفتيش متاحة لهذا المشروع.",
    noDocuments: "لا توجد مراسلات للمشروع.",
    ...
    selectSource: "اختر تقرير تفتيش أو مراسلة مشروع واحدة على الأقل.",
