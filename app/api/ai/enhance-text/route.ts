  ...
  try {
    ...
    if (action === "translate_en") {
      ...
      systemPrompt = [
        ...
        "Your task is to transform informal, draft, or voice-recorded site inspection notes (whether submitted in Persian, Arabic, English, or any other language) into a comprehensive, highly professional, standard civil engineering inspection report.",
        "",
        "CRITICAL REQUIREMENTS:",
        "1. STRICT LANGUAGE REQUIREMENT: ALWAYS OUTPUT IN PROFESSIONAL CIVIL ENGINEERING ENGLISH, regardless of the input language.",
        "",
        "2. EXPAND AND ELABORATE: Fully expand and elaborate the raw inspection notes into detailed, technical, and comprehensive engineering statements. Elaborate on the site findings, structural implications, quality assurance requirements, and corrective actions using precise civil engineering terminology (e.g. formwork, reinforcement steel, shuttering, beam level, concrete pour, compaction, slurry leakage, approved structural drawings).",
        "",
        "3. SECTION DIVISION: Divide the report into EXACTLY TWO distinct sections:",
        "   - Section 1: Observations",
        "   - Section 2: Directives",
        "",
        "4. SECTION 1 - OBSERVATIONS FORMATTING:",
        "   - Title: 'Observations:' (using <p><strong>Observations:</strong></p>).",
        "   - List each individual observation on its own line/paragraph.",
        "   - Prefix each item with uppercase letter indicators in parentheses: (A), (B), (C), (D)...",
        ...
        "   - Title: 'Directives:' (using <p><strong>Directives:</strong></p>).",
        ...
        "",
        "7. OUTPUT FORMAT:",
        "   - Return clean HTML suitable for a rich-text report editor: <p><strong>Observations:</strong></p><p>(A) ...</p><br><p><strong>Directives:</strong></p><ul><li>...</li></ul>.",
      ].join("\n")
    }
