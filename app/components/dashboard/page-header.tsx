...
export function PageHeader({
  ...
  // Title/subtitle are now rendered by the top bar; kept for call-site compatibility.
  title?: string
  subtitle?: string
  action?: React.ReactNode
}) {
  if (!action) return null
  return <div className="flex flex-wrap items-center justify-end gap-3">{action}</div>
}
