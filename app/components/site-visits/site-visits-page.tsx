  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div><h2 className="text-xl font-semibold">{title}</h2><p className="mt-1 text-sm text-muted-foreground">Request, review, schedule, and track project site visits.</p>{data.selectedProjectName ? <p className="mt-1 text-sm font-medium">{data.selectedProjectName}</p> : null}</div>
